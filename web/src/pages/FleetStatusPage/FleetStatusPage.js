...
import FleetProSuperCell from 'src/components/FleetProSuperCell/FleetProSuperCell'
import FleetPercentageCell from 'src/components/FleetPercentageCell/FleetPercentageCell'
import FleetBootsCell from 'src/components/FleetBootsCell/FleetBootsCell'
...
const FleetStatusPage = () => {
  ...
  return (
    <>
      <MetaTags title="FleetStatus" description="FleetStatus page" />
      <Box
        sx={{
          display: 'flex',
          flexDirection: 'row',
      ...
      {hasRole(['lead pro super', 'pro super']) ? (
        <FleetProSuperCell unit_id={currentUser?.shop.unit_id} />
      ) : (
        <FleetBootsCell
